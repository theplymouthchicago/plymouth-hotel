  ...
  return (
    <section className="bg-plymouth-black py-16 border-t border-plymouth-gold/20">
      <div className="max-w-3xl mx-auto text-center px-6">
        ...
        <p className="text-plymouth-cream/70 text-lg max-w-xl mx-auto mb-8">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 bg-plymouth-brass text-plymouth-forest-deep px-8 py-3 text-sm tracking-widest uppercase font-medium hover:bg-plymouth-cream transition-all"
        >
