      ...
      <div className="max-w-container-lg mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
          {testimonials.map((t, index) => (
            <ScrollReveal key={t.name} delay={index * 120}>
              <div className="bg-plymouth-white p-8 md:p-10 border border-plymouth-black/5 h-full flex flex-col">
                {/* Stars */}
                ...
                <blockquote className="text-plymouth-black leading-relaxed mb-8 flex-1">
                  &ldquo;{t.quote}&rdquo;
                </blockquote>
